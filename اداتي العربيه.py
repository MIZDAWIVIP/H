...
if [ $# -ne 1 ]; then
    echo "يرجى كتابة اسم اداة بايثون التي تريد فكها"
    exit 1
fi
...
''')
        ...
        print("\033[2;32m \n \n تم التثبيت بنجاح يمكنك الاستخدام بواسطة الامر MIZDAWI")
Marshal_Setup()
